...
CREATE TABLE "grade_levels" (
  "grade_level_id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "grade_level_name" varchar,
  "grade_level_chair" bigint UNIQUE
);
...
CREATE TABLE "relationship_type" (
  "relationship_type_id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE "daily_attendance" (
  "daily_attendance_id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "student_id" bigint,
  "date" date,
...
CREATE TABLE "iep" (
  "iep_id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "student_id" bigint,
  "iep_summary" varchar
  -- "last_updated" date
);
...
CREATE TABLE "etr" (
  "etr_id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  "student_id" bigint,
  "last_updated" date,
...
ALTER TABLE "student" ADD FOREIGN KEY ("grade_level_id") REFERENCES "grade_levels" ("grade_level_id");
